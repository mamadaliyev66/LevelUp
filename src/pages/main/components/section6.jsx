        ...
        <div className="container flex justify-center mx-auto pt-16">
                ...
                <div className="w-full bg-gray-100 dark:bg-gray-800 px-10 pt-10">
                    ...
                    {data?(data.map((member,i)=>{
                           return(         
                            <div key={member.member_id} role="listitem" className="xl:w-1/3 sm:w-3/4 md:w-2/5 hover:shadow-2xl transition-all duration-300 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
