...
export default function Contact() {
  return (
        ...
        <div className="max-w-6xl mx-auto py-44 bg-white my-6 font-[sans-serif] text-[#011c2b]">
            ...
            <div className="grid lg:grid-cols-3 my-3 items-center gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-8">
                <div className="bg-blue-500 rounded-lg p-6 max-lg:text-center">
                    <h2 className="text-xl font-bold text-white">Contact Information</h2>
                    <p className="text-sm text-white mt-3">Have some big idea or brand to develop and need help?</p>
                    ...
                    <ul className="flex max-lg:justify-center mt-16 space-x-4">
                        <li className="bg-white h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                            <a href="javascript:void(0)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" fill='#000'
                                    viewBox="0 0 24 24">
                                    <path
                ...
                <div className="p-6 rounded-xl lg:col-span-2">
                    <form>
                        ...
                        <button type="button"
                            className="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded px-4 py-2.5 font-semibold bg-blue-500 text-white hover:bg-blue-700">
